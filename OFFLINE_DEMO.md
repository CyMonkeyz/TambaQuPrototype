...
3. Open Demo Control → **Simulasi Koneksi Aplikasi** → **Offline**.
...
8. Navigate Dashboard → Ponds → Pond Detail → PondBrain → Alerts. Cached data remains available.
9. Return to Demo Control and choose **Online**.
